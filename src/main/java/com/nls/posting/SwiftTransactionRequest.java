...
@JsonbPropertyOrder({
  ...
  "reqSwiftRoutingCode",
  "reqSenderCorresBankBIC",
  "reqSenderCorresBankAccNo",
  "reqRecieverCorresBankBIC",
  "reqIntermediarySWIFTCountryCode",
  "reqRecieverBankBIC",
  "reqClearingCode",
  "reqRemittanceInfo",
  "reqChargeType",
  ...
  "reqBeneficiaryBankAddress2",
  "reqBatchReferenceNo",
  "reqIntermediaryBankAddress1",
  "reqIntermediaryBankAddress2",
  "reqIntermediaryBankAddress3",
  "reqIntermediaryBankAddress4",
  "reqIntermediaryBankBIC",
  "reqpurposecodedesc",
  "reqFirstLegRefNo",
  "vipMarker",
  "waiveCharge"
...
public class SwiftTransactionRequest {
  ...
  @Schema(required = false, example = "", description = "Req PostingBranch")
  ...
  @Schema(required = false, example = "8943", description = "req ForceCreditFlag")
  ...
  @Schema(required = false, example = "", description = "req BeneficiaryName")
  @JsonbProperty("reqBeneficiaryName")
  public String reqBeneficiaryName;

  @Schema(required = false, example = "", description = "req PayCurrency")
  ...
  @Schema(required = false, example = "", description = "req BeneCountry")
  ...
  @Schema(required = false, example = "", description = "req BeneBankName")
  ...
  @Schema(required = false, example = "", description = "System DateTime")
