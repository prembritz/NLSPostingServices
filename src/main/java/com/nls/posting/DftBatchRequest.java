...
public class DftBatchRequest {
  ...
  public static class BatchData {
    ...
    @Schema(required = true, example = "20208ABCD", description = "Req Transaction ReferenceNo")
