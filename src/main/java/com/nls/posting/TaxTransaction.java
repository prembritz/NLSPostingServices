...
public class TaxTransaction {
  ...
  @APIResponseSchema(
      value = TaxTransactionObject.class,
      responseDescription = "Tax Transaction Response",
      responseCode = "200")
  @Operation(summary = "Tax Transaction Request", description = "returns Tax Transaction data")
  public Response getTaxTransactionDetails(
      @RequestBody(
              ...
              content =
                  @Content(
                      ...
                      schema = @Schema(implementation = TaxTransactionRequest.class)))
    ...
    try {
      System.out.println("Tax Transaction Posting Started on [" + startTime + "]");
      ...
      String ServiceName = "TaxTransaction";
      String CBXReference = "";
      ...
      System.out.println("Fetching Tax Transaction Details Transaction Id [" + SourceUniqRef + "]");
      ...
      try {
        if (ValidationStatus.equalsIgnoreCase(ResponseStatus.SUCCESS.getValue())
          ...
          Field[] fields = TaxTransactionRequest.class.getDeclaredFields();
      ...
      try {
        if (QueueStatus.equalsIgnoreCase(ResponseStatus.SUCCESS.getValue())) {
          ...
          Field[] resfields = TaxTransactionObject.class.getDeclaredFields();
          for (Field field : resfields) {
            if (field.isAnnotationPresent(JsonbProperty.class)) {
              String annotationValue = field.getAnnotation(JsonbProperty.class).value();
      ...
      System.out.println(
          "Tax Transaction Posting Completed and Processing Time Taken [ "
              + millis
              + " ] MilliSeconds");
    }
  }
  ...
  private void ResponseMessages(
      TaxTransactionObject TaxTransObj,
      String SourceUniqRef,
      String UniqueReference,
