...
public class StopChequePaymentObject {
  ...
  @JsonbProperty("res_ErrorMessage")
  public String resErrorMessage = "success";

  @JsonbProperty("chequeRanges")
  public String chequeRanges;

  public String getChequeRanges() {
    return chequeRanges;
  }

  public void setChequeRanges(String chequeRanges) {
    this.chequeRanges = chequeRanges;
  }
  ...
  public StopChequePaymentObject() {
    ...
    this.setChequeRanges(chequeRanges);
  }
}
