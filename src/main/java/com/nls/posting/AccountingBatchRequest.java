...
@Schema(
    ...
    description = "request object with HdrTranId, hdrStatus, req_UnitID, req_ChannelName...etc")
public class AccountingBatchRequest {

  @Schema(required = true, example = "TBC1502211515001", description = "Req File Reference No")
  @JsonbProperty("reqFileRefNo")
  public String reqFileRefNo;

  @Schema(required = true, example = "TBC1502211513002", description = "Req Batch Ref No")
  ...
  public static class BatchData {
    ...
    @Schema(required = false, example = "2020-06-06", description = "req ValueDate")
    ...
    @Schema(required = false, example = "20", description = "req Debit Account Category")
    @JsonbProperty("reqDebitAccCategory")
    public String reqDebitAccCategory;

    @Schema(required = false, example = "NA", description = "req Force Debit Flag")
    ...
    @Schema(required = false, example = "USD", description = "req Buy Rate")
    @JsonbProperty("reqBuyRate")
    public String reqBuyRate;

    @Schema(required = false, example = "100", description = "req DebitBase Equivalent")
    @JsonbProperty("reqDebitBaseEquivalent")
    public String reqDebitBaseEquivalent;

    @Schema(required = false, example = "NA", description = "req Debit source Branch")
    @JsonbProperty("reqDebitSourceBranch")
    public String reqDebitSourceBranch;

    @Schema(required = false, example = "N", description = "req Debit Transaction code")
    @JsonbProperty("reqDebitTransactionCode")
    public String reqDebitTransactionCode;

    @Schema(required = false, example = "59", description = "req Trans Debit Reference no")
    ...
    @Schema(required = false, example = "", description = "req Credit Acc Category")
    @JsonbProperty("reqCreditAccCategory")
    public String reqCreditAccCategory;

    @Schema(required = false, example = "", description = "req Force Credit Flag")
    @JsonbProperty("reqForceCreditFlag")
    public String reqForceCreditFlag;

    @Schema(required = false, example = "", description = "req Credit Amount")
    @JsonbProperty("reqCreditAmount")
    public String reqCreditAmount;

    @Schema(required = false, example = "", description = "req Credit Currency")
    ...
    @Schema(required = false, example = "", description = "req sell Rate")
    @JsonbProperty("reqSellRate")
    public String reqSellRate;

    @Schema(required = false, example = "", description = "req Credit Base Equivalent")
  ...
  @JsonbProperty("A2ABATCHDATA")
  public List<BatchData> batchData;

  /*
   * @JsonbProperty("CBFT_BATCH_HEADER") public Map<String, String> batchHeader;
   */
