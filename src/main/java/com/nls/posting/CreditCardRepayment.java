...
public class CreditCardRepayment {
  ...
  public static void SetSchemaNames(String coreDBSchema, String channelSchema) {
    CreditCardRepayment.coreDBSchema = coreDBSchema;
    CreditCardRepayment.channelSchema = channelSchema;
  }

  public static void setDBPool(DataSource cmDBPool) {
    CreditCardRepayment.cmDBPool = cmDBPool;
  }

  public static void setExternalTablenames(HashMap<String, String> ActualTableName) {
    CreditCardRepayment.ActualTableName = ActualTableName;
  }

  public static void setInitiailizeGlobalParameters(HashMap<String, String> GlobalParameters) {
    CreditCardRepayment.GlobalParameters = GlobalParameters;
  }

  private static CoreServices coreServices;

  public static void setCoreServices(CoreServices coreServices) {
    CreditCardRepayment.coreServices = coreServices;
  }
  ...
  @APIResponseSchema(
      value = CreditCardRepaymentObject.class,
      responseDescription = "Credit Card Repayment Response",
      responseCode = "200")
  @Operation(
      summary = "Credit Card Repayment Request",
      description = "returns Credit Card Repayment data")
  public Response getCreditCardRepaymentDetails(
      @RequestBody(
              ...
              content =
                  @Content(
                      ...
                      schema = @Schema(implementation = CreditCardRepaymentRequest.class)))
          CreditCardRepaymentRequest id) {

    CreditCardRepaymentObject CCRObj = new CreditCardRepaymentObject();
    ...
    try {
      System.out.println("CreditCard Payment Posting Started on [" + startTime + "]");
      ...
      String ServiceName = "CreditCardRepayment";
      String CBXReference = "";
      ...
      System.out.println(
          "Fetching Credit Card Repayment Details Transaction Id [" + SourceUniqRef + "]");
      ...
      try {
        if (ValidationStatus.equalsIgnoreCase(ResponseStatus.SUCCESS.getValue())
          ...
          Field[] fields = CreditCardRepaymentRequest.class.getDeclaredFields();
      ...
      try {
        if (QueueStatus.equalsIgnoreCase(ResponseStatus.SUCCESS.getValue())) {
          ...
          CreditAccountno = GlobalParameters.get("CREDIT_CARD_CREDIT_ACC_NUMBER");
          ...
          Field[] resfields = CreditCardRepaymentObject.class.getDeclaredFields();
          for (Field field : resfields) {
            if (field.isAnnotationPresent(JsonbProperty.class)) {
              String annotationValue = field.getAnnotation(JsonbProperty.class).value();
  ...
  private void ResponseMessages(
      CreditCardRepaymentObject CCRObj,
      String SourceUniqRef,
      String UniqueReference,
