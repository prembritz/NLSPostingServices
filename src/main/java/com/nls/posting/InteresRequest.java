...
public class InteresRequest {
  ...
  @Schema(required = true, example = "InterestPosting", description = "ProCode")
  ...
  @Schema(required = true, example = "1672110013", description = "SettlementAccountNo")
  ...
  @Schema(required = false, example = "DOMEWT -TBS2104090375861 - -", description = "Narration")
  @JsonbProperty("reqNarration")
  public String narration;

  @Schema(required = false, example = "C", description = "DRCRFlag")
