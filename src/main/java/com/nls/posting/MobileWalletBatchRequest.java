...
public class MobileWalletBatchRequest {
  ...
  @Schema(required = true, example = "3", description = "Req No of Transactions")
  ...
  public static class MobileBatchData {
    @Schema(
        required = false,
        example = "N",
    ...
    @Schema(required = true, example = "", description = "req Card No")
    ...
    @Schema(required = true, example = "100", description = "req Amt")
    @JsonbProperty("reqAmt")
    public String reqAmt;

    @Schema(required = true, example = "KES", description = "req Txn CCY")
  ...
  @JsonbProperty("MOBILEWALLETBATCHDATA")
  public List<MobileBatchData> mobileBatchData;
